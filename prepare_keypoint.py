...
from txt2json_keypoint import collect_unaug_dataset, convert
...
img_dic = collect_unaug_dataset( os.path.join( T_ROOT, "train_cut", "labelTxt" ) )
...
# img_dic["bridge"] = img_dic["bridge"] * 4
img_dic["basketball-court"] = img_dic["basketball-court"] * 4
img_dic["helicopter"] = img_dic["helicopter"] * 8

convert( img_dic, os.path.join( T_ROOT, "train_cut" ),  os.path.join( T_ROOT, "train_cut", "train_cut.json" ) )
