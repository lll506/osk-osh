...
class iou_test(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, iou_test, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, iou_test, name)
    __repr__ = _swig_repr
    __swig_setmethods__["iou"] = _polyiou.iou_test_iou_set
    __swig_getmethods__["iou"] = _polyiou.iou_test_iou_get
    if _newclass:
        iou = _swig_property(_polyiou.iou_test_iou_get, _polyiou.iou_test_iou_set)
    __swig_setmethods__["inter1"] = _polyiou.iou_test_inter1_set
    __swig_getmethods__["inter1"] = _polyiou.iou_test_inter1_get
    if _newclass:
        inter1 = _swig_property(_polyiou.iou_test_inter1_get, _polyiou.iou_test_inter1_set)
    __swig_setmethods__["inter2"] = _polyiou.iou_test_inter2_set
    __swig_getmethods__["inter2"] = _polyiou.iou_test_inter2_get
    if _newclass:
        inter2 = _swig_property(_polyiou.iou_test_inter2_get, _polyiou.iou_test_inter2_set)

    def __init__(self):
        this = _polyiou.new_iou_test()
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    __swig_destroy__ = _polyiou.delete_iou_test
    __del__ = lambda self: None
iou_test_swigregister = _polyiou.iou_test_swigregister
iou_test_swigregister(iou_test)
