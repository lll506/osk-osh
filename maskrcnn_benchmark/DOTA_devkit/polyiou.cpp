...
iou_test iou_poly(vector<double> p, vector<double> q) {
    iou_test iou_new;
    ...
    iou_new.iou = inter_area / union_area;
    iou_new.inter1 = inter_area / fabs(area(ps1, n1));
    iou_new.inter2 = inter_area / fabs(area(ps2, n2));
